...
pub fn I() -> impl IntoView {
    view! {
        <div>
            ...
            <p>"跨平台客户端：tauri"</p>
            <p>"云服务器、域名：腾迅云"</p>
            <p>"代码平台：https://github.com/myw"</p>
            <p>"js、scss、remixicon、web_sys、serde、tokio"</p>

            <myw::Gap h=30/>
            <h2>"联系我"</h2>
            <p>"建议与反馈邮箱：i@mayiwen.com"</p>
            <p>"在github联系我：https://github.com/myw"</p>
            <p>"在gitlink联系我：https://gitlink.org.cn/myw"</p>
            <myw::Gap h=30/>
            <h2>"版本"</h2>
            <p>"1.2.4"</p>
            <p>"更新日期: 2025-11-01          "</p>
            ...
            <p>"2026-01-02 1.2.5 前端框架切到leptos，使用ssr重构网站"</p>
        </div>
    }
}
